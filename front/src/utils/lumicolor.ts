...
export type HexContrastColor = "#000000" | "#FFFFFF";

/* =========================================================
   COLOR CONVERSION & LUMINANCE HELPERS
========================================================= */

/**
 * Normalizes and converts diverse hex string formatting into standard RGB channels
 * @returns [r, g, b] channels calibrated from 0 to 255, or null on parse failure
 */
function parseHexToRgb(hex: string): RGBTuple | null {
 ...
 * @param hexColor A 3, 4, 6, or 8 digit hex color string.
 ...
 * @param bgColor Hex code of background color
 * @returns Hex code for highest contrast layout text ("#000000" or "#FFFFFF")
 */
export function getContrastColor(bgColor: string): HexContrastColor {
 ...
 * @param bgColor Target hex background color string
 */
export function applyButtonColors(element: HTMLElement | null, bgColor: string): void {

...
import { renderMarkers, attachMarkerEvents } from "./renderMarkers.js";
...
function createZoomControls(state, mapOptions, mapContainer, mapWrapper, minimap, minimapViewport) {
  ...
  if (Array.isArray(mapOptions.customControls)) {
...
function createLegend() {
  ...
  return createElement("div", { style: "display:flex;align-items:center;gap:4px;" }, [legend, toggleBtn]);
}
...
export function displayGenericMap(container, options = {}) {
  ...
  attachMarkerEvents(markerLayer, mapOptions);
